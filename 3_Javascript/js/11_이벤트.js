...
function check1(btn) {
    ...
    // 버튼의 배경색을 얻어와 저장
    // document.get... / this를 사용해서 이거 안써도 됨
...
// #test1-3 요소를 얻어와 testlc 변수에 저장
const test1c = document.querySelector("#test1-3");

// #test1-3 요소가 클릭 되었을 떄 배경색을 red로 변경
...
test2.addEventListener("click", function() {
    ...
    // 앞에 this 말고 test2 써도됨
    // ex) test2.innerText = count;
});
