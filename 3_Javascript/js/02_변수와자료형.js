...
// 1. var (변수, 변수 선언 시 중복된느 변수명으로 선언 가능)
//      -> 먼저 선언도니 변수가 나중에 선언도니 변수에 덮어 씌워짐
...
// PI = 1.23;
// 오류 문구 : const PI = 3.141592; Uncaught TypeError: Assignment to constant variable.
...
// boolean (논리 값 ture/false)
// boolean 변수는 이름지을 때 보통 앞에 is를 붙인다.
const isTrue = true;
const isFalse = false;
...
// V(value) : K의 대응되는 값 (변수에 대입되는 값 비슷)
...
console.log(typeof sumFn); // funcion
